...
#C file write time: 2025-06-29  11:27:37
data.ss
control.ss
...
2 10 #COND 10 15 #_min and max age over which mean F will be calculated with F_reporting=4 or 5
...
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1751158153
